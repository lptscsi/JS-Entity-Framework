...
export type { DATA_OPER, DELETE_ACTION, FLAGS, REFRESH_MODE } from "./jriapp_db/const";
...
export type {
    IAssociationInfo, IDbSetConstuctorOptions, IDbSetLoadedArgs, IEntityItem, IErrorInfo, IColumn, IFilterInfo, IMetadata, 
    IQueryInfo, IQueryResult, IRowData, ISortInfo, IValidationErrorInfo
} from "./jriapp_db/int";

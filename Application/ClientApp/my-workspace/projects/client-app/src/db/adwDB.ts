/*
	Generated from: /RIAppDemoServiceEF/typescript on 2026-07-15 at 21:23
...
export class DbSets extends RIAPP.DbSets{
	...
	get Customer() { return this.getDbSet("Customer") as unknown as CustomerDb; }
	get CustomerAddress() { return this.getDbSet("CustomerAddress") as unknown as CustomerAddressDb; }
	get CustomerJSON() { return this.getDbSet("CustomerJSON") as unknown as CustomerJSONDb; }
	get LookUpProduct() { return this.getDbSet("LookUpProduct") as unknown as LookUpProductDb; }
	get Product() { return this.getDbSet("Product") as unknown as ProductDb; }
	get ProductCategory() { return this.getDbSet("ProductCategory") as unknown as ProductCategoryDb; }
	get ProductDescription() { return this.getDbSet("ProductDescription") as unknown as ProductDescriptionDb; }
	get ProductModel() { return this.getDbSet("ProductModel") as unknown as ProductModelDb; }
	get ProductModelProductDescription() { return this.getDbSet("ProductModelProductDescription") as unknown as ProductModelProductDescriptionDb; }
	get SalesInfo() { return this.getDbSet("SalesInfo") as unknown as SalesInfoDb; }
	get SalesOrderDetail() { return this.getDbSet("SalesOrderDetail") as unknown as SalesOrderDetailDb; }
	get SalesOrderHeader() { return this.getDbSet("SalesOrderHeader") as unknown as SalesOrderHeaderDb; }
}
